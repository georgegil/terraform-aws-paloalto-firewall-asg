...
variable "lc_name" {
  description = "A name for the ASG's launch configuration. This name will be interpolated into the ASG so they are tied together for all TF operations."
  type        = string
}
...
variable "os_volume_size" {
  description = "The size in GBs of the OS volume in GB."
  type        = string
}

variable "os_volume_type" {
  description = "The type of volume to use.  Example: 'gp2', 'io1', 'st1'. See related links for 'AWS EBS Volume Types'."
  type        = string
}
...
variable "placement_tenancy" {
  description = "The tenancy of the instance. Valid values are 'default' or 'dedicated'. See 'AWS's Create Launch Configuration' in related links for more details."
  type        = string
  default     = "default"
}
...
variable "initial_lifecycle_notification_target_arn" {
...
variable "initial_lifecycle_role_arn" {
